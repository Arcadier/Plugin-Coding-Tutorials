...
function makeCustomField(name,table,exists,code,id,value){
  ...
  */
  ...
  /*Using ajax to send the data to PHP file. Synchronous ajax (async:false) is used here because
  the function needs to assign result to FinalResults before it returns FinalResult.*/
